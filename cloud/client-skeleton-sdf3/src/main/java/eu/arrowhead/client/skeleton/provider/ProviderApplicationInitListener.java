...
//	private String mySystemName = "sdf3_provider";
	
	@Value(ClientCommonConstants.$CLIENT_SERVER_ADDRESS_WD)
	private String mySystemAddress;
//	private String mySystemAddress="131.155.247.75";
	
	@Value(ClientCommonConstants.$CLIENT_SERVER_PORT_WD)
	private int mySystemPort;
//	private int mySystemPort=11989;
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO createServiceRequest = createServiceRegistryRequest(ProviderConstants.GET_SERVICE_DEFINITION, ProviderConstants.GET_SERVICE_URI, HttpMethod.POST);		
		//createServiceRequest.getMetadata().put(ProviderConstants.REQUEST_PARAM_KEY_TEXT, ProviderConstants.REQUEST_PARAM_TEXT);
		

		arrowheadService.forceRegisterServiceToServiceRegistry(createServiceRequest);
		logger.info("Service registered: {}", ProviderConstants.GET_SERVICE_DEFINITION);
		
		Scanner sc= new Scanner(System.in);
		System.out.print("\nSDF3 provider running. Enter file location.\n"); 
		String loc=sc.nextLine(); 
		ProviderConstants.FILE_LOCATION=loc;
	...
	public void customDestroy() {
		...
		arrowheadService.unregisterServiceFromServiceRegistry(ProviderConstants.GET_SERVICE_DEFINITION);
		logger.info("Service unregistered: {}", ProviderConstants.GET_SERVICE_DEFINITION);
	}
