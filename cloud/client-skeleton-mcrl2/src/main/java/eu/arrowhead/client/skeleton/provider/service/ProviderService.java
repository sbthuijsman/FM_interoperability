...
public class ProviderService {
	...
	public String getCombText(final String textToAdd){
		...
		locat=ProviderConstants.FILE_LOCATION+"\\"+"mcrl2file.mcrl2";
		Path path=Paths.get(locat);

		locat2=ProviderConstants.FILE_LOCATION+"\\"+"verify";
		...
		try{
			...
			System.out.print("\n"+data1+"\n");
			String loc= ProviderConstants.FILE_LOCATION+"\\"+"result.txt";
