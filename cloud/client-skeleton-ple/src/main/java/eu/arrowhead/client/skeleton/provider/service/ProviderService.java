...
public class ProviderService {
	...
	public String getSup(final String textToAdd){
		...
		locat=ProviderConstants.FILE_LOCATION+"\\"+"inputTemp.txt";
		Path path=Paths.get(locat);

		locat2=ProviderConstants.FILE_LOCATION+"\\"+"derivevariant.bat";
		...
		try{
			ProcessBuilder launcher =new ProcessBuilder(path2.toString());
			Process process=launcher.start();
			process.waitFor();
			String data1="Process completed successfully!";
			System.out.print("\n"+data1+"\n");
			String loc= ProviderConstants.FILE_LOCATION+"\\"+"twilight.activity";
