...
public class ProviderController {
	...
	@ResponseBody public String getSupervisor(@RequestBody final String textToAdd){
		//final Resource resource = new ClassPathResource("testFile.txt");
		//final InputStream reader = resource.getInputStream();
		//final BufferedReader reader = new BufferedReader(new InputStreamReader(resource.getInputStream()));
		return providerService.getSup(textToAdd);
	}
